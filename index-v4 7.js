...
function gameUrl(telegramId) {
  // Telegram strips ?query params from web_app URLs
  // Use hash fragment instead — this survives
...
// ── CLICK — captcha disabled, direct recording ──
app.post('/api/game/click', async(req,res)=>{
  try {
    ...
    // Mark as verified human on first click
